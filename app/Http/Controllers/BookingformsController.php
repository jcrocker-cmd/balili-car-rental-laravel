...
{ 
    ...
    $car_details = AddCar::where('slug', $slug)->first();
        ...
        $data = [
            ...
            'payment' => $request->payment,
            'rental_duration' => $request->rental_duration,
            'start_date' => $request->start_date_weekly,
            'start_time' => $request->start_time_weekly,
            'return_date' => $request->return_date_weekly,
            'return_time' => $request->return_time_weekly,
            'total_amount_payable' => $request->total_amount_payable,
            'msg' => $request->msg,
            'car_details' => $car_details,
        ];
    ...
    $car_details = AddCar::where('slug', $slug)->first();
        ...
        $data = [
            ...
            'payment' => $request->payment,
            'rental_duration' => $request->rental_duration,
            'start_date' => $request->start_date_monthly,
            'start_time' => $request->start_time_monthly,
            'return_date' => $request->return_date_monthly,
            'return_time' => $request->return_time_monthly,
            'total_amount_payable' => $request->total_amount_payable,
            'msg' => $request->msg,
            'car_details' => $car_details,
        ];
