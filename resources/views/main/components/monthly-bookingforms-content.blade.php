                ...
                <div class="sect-1">
                        ...
                        <div class="d-flex renter-info" >
                            ...
                            <div class="intl-tel-input" style="width: 100%;">
                                ...
                                <input type="tel" id="whatsapp_viberNumber_monthly" class="form-control" placeholder="WhatsApp or Viber number" oninput="setPhoneDataMonthly()" required>
                    ...
                    <div class="sect-2">
                        ...
                        <div class="price-info">
                            ...
                            <div style="width: 100%;" hidden>
                                ...
                                <input type="text" id="car_price_monthly" name="" value="{{ $car_details->monthlyrate}}">
                            </div>
