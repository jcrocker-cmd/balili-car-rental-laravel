<section class="booking-form-section">
    ...
    <section class="">
    <form enctype="multipart/form-data" action="{{ url('weekly_bookingformsubmit', ['slug' => $car_details->slug]) }}" method="POST" id="weekly_bookingForm" class="was-validated" onsubmit="setPhoneData()">
                  @csrf
