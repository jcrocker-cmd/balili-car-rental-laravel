<section class="booking-form-section">
    ...
    <section class="">
    <form enctype="multipart/form-data" action="{{ url('bookingformsubmit', ['slug' => $car_details->slug]) }}" method="POST" id="daily_bookingForm" class="was-validated" onsubmit="setPhoneData()">
                  @csrf
