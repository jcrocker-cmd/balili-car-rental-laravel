<section class="">
    <form enctype="multipart/form-data" action="{{ url('bookingformsubmit', ['slug' => $car_details->slug]) }}"
        method="POST" id="daily_bookingForm" class="was-validated">
        @csrf
            ...
            <div class="sect-1">
                ...
                <div class="d-flex renter-info">
                    ...
                    <div class="intl-tel-input" style="width: 100%;">
                        ...
                        <input type="tel" id="whatsapp_viberNumber" class="form-control"
                            placeholder="WhatsApp or Viber number" oninput="setPhoneData()" required>
                ...
                <div style="margin-bottom: 25px;" class="requirements">
                    ...
                    <div class="form-check pb-2">
                        <input class="form-check-input" name="cashbond" id="cashbond" type="checkbox" value="2000"
                            required>
                ...
                <div style="margin-bottom: 20px;" class="mode_del">
                    ...
                    <div class="d-flex align-items-center mode-of-delivery mx-0">
                        <div class="form-check">
                            <input class="form-check-input mode_del" type="radio" name="mode_del" id="opt1"
                        ...
                        <div class="form-check">
                            <input class="form-check-input mode_del" type="radio" name="mode_del" id="opt2"
                        ...
                        <div class="form-check">
                            <input class="form-check-input mode_del" type="radio" name="mode_del" id="opt3"
                        ...
                        <div class="form-check">
                            <input class="form-check-input mode_del" type="radio" name="mode_del" id="opt4"
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="mode_del" id="opt5"
            ...
            <div class="sect-2">
                <div class="car-rent-info-wrapper">
                    ...
                    <div class="d-flex justify-content-between align-items-center pb-2">
                        <div classs="">
                            ...
                            <div class="car_price"><strong>₱ {{ number_format($car_details->dailyrate) }} /
                                    Daily</strong></div>
                        </div>
                        <div class="car-image">
                ...
                <div class="price-info">
                    ...
                    <div style="width: 100%;" hidden>
                        ...
                        <input type="text" id="total_days_input" name="total_days" placeholder="Enter Address"
                            value="0">
                    </div>
                    ...
                    <div style="width: 100%;" hidden>
                        ...
                        <input type="text" id="cashbondAmount_input" name="cashbondAmount" placeholder="Enter Address"
                            value="0">
                    </div>
                    ...
                    <div style="width: 100%;" hidden>
                        ...
                        <input type="text" id="delivery_fee_value_input" name="deliveryFee" placeholder="Enter Address"
                            value="0">
                    </div>
                    ...
                    <div style="width: 100%;" hidden>
                        ...
                        <input type="number" id="vat_input" name="total_days" value="0"
